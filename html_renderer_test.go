...
func renderHookEmpty(r *html.Renderer, w io.Writer, node ast.Node, entering bool) (ast.WalkStatus, bool) {
...
func renderHookCodeBlock(r *html.Renderer, w io.Writer, node ast.Node, entering bool) (ast.WalkStatus, bool) {
...
func TestRenderNodeHookLinkAttrs(t *testing.T) {
	...
	opts := html.RendererOptions{
		RenderNodeHook: func(r *html.Renderer, w io.Writer, node ast.Node, entering bool) (ast.WalkStatus, bool) {
