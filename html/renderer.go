...
type RenderNodeFunc func(r *Renderer, w io.Writer, node ast.Node, entering bool) (ast.WalkStatus, bool)
...
func (r *Renderer) RenderNode(w io.Writer, node ast.Node, entering bool) ast.WalkStatus {
	if r.Opts.RenderNodeHook != nil {
		status, didHandle := r.Opts.RenderNodeHook(r, w, node, entering)
		if didHandle {
			return status
		}
	}
